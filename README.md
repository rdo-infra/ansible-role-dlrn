...
* `dlrn_workers` (optional). This dictionary contains the definition of all workers to be deployed
  ...
  - `push_ssh_pubkey_to_gerrit` (optional): push the SSH public key of the worker to the gerrit_user 
    Gerrit account. Only used if gerrit_user and gerrit_password are defined.
    Defaults to false.
