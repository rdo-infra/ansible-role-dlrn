...
* `api_read_write_roles` (required for authorization). Role to be used for allowing to consume HTTP POST endpoints. It also allows to consume HTTP GET endpoints.
